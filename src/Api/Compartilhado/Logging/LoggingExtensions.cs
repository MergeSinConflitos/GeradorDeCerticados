...
namespace GeradorDeCertificados.Api.Compartilhado.Logging;
        ...
        if (newRelicOptions.Enabled)
        {
                ...
                newRelicOptions.LicenseKey))
            {
                throw new InvalidOperationException(
                    "A chave de licença do New Relic não foi configurada. " +
                    "Configure Infra:NewRelic:LicenseKey."
                );
            }
