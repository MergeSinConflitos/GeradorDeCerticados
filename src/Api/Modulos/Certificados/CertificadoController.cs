...
) : ControllerBase
{
    [Authorize]
    [HttpPost]
    [ProducesResponseType<SolicitarCertificadosResponse>(
    ...
    [ProducesResponseType<StatusSolicitacaoResponse>(
    ...
    [Authorize]
    [HttpGet]
    [ProducesResponseType<List<CertificadoResponse>>(
        StatusCodes.Status200OK
    )]
    ...
    )
    {
        ...
        List<CertificadoResponse> response =
            resultado.Value
                .Select(certificado =>
                    new CertificadoResponse(
                        certificado.Id,
                        certificado.CursoId,
